...
# new_text = "새벽 2시 31분 창고 출입구 칩입. person:2 car:1 탐지. 위험. 경찰 출동 후 용의자 검거"
# collection.update(
#   ids=['log_001'],
#   embeddings=[get_embedding(new_text)], # 내용이 바뀌었으므로 벡터 재생성이 필수
#   documents=[new_text],
...
# print(f"log_002: {result2['documents'][0]}")
# print(f"         resolved={result2['metadatas'][0]['resolved']} (문서 내용은 그대로)\n")
