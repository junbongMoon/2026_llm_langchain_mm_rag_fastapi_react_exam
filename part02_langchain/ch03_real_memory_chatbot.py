...
from langchain_core.messages import (
    ...
    HumanMessage,   # 사람이 LLM에게 전달할 프롬프트를 만들 클래스
    AIMessage,      # LLM이 응답한 메세지
)
from langchain_core.chat_history import InMemoryChatMessageHistory  # 메모리 + 요약 기능이 구현된 클래스
...
class CCTVOperatorChatbot : 
    ...
    def __init__(self) :
        ...
        self.frame_cache: dict = {}  # 프레임을 임시 저장하는 메모리
    ...
    # JsonOutputParser는 랭체인 전용 컴포넌트. 이 예제는 프레임 분석을 요청하는 프롬프트와
