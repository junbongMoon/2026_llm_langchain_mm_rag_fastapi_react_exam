...
def execute_tool_calls(tool_calls: list) -> list : 
    ...
    for tc in tool_calls : 
        ...
        # LLM에게 ToolMessage 리스트를 줄 때 어떤 Tool에 대한 호출 결과인지를 알려주기 위해서
        tool_id = tc['id']
...
"""
    ...
    def run(self, query:str) -> str : 
        ...
        #
        #   2. Tool이 필요하다고 판단
        #      → response.tool_calls에 답변 작성을 위해 어떤 툴이 필요한지 Tool 호출 요청
        #
        # 주의:
