...
def split_into_sentence(text:str, max_chars:int = 200) -> list:
    """
    긴 텍스트를 문장 단위로 분할합니다.
...
def tts_streaming_save(text :str, output_dir:str ="briefing_chunks", voice:str = "onyx") -> list :
    """ 
    ...
    chunks = split_into_sentence(text)
